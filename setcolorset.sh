...
sudo sed -i '/^\[/h;G;/Last/s/\(LastNum=\).*/\1'"$1"'/m;P;d'  /usr/local/etc/Nextion_Support/Colors.ini
sudo sed -i '/^\[/h;G;/Last/s/\(LastSplit=\).*/\1'"$2"'/m;P;d'  /usr/local/etc/Nextion_Support/Colors.ini
